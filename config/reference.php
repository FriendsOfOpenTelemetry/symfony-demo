 ...
 * }
 * @psalm-type OpenTelemetryConfig = array{
 *     transport_http_client?: scalar|Param|null, // Service ID used for telemetry export transports. Must implement PSR-18 ClientInterface and PSR-17 RequestFactoryInterface, StreamFactoryInterface. Defaults to Symfony Psr18Client. // Default: null
 *     service?: array{
 *         namespace?: scalar|Param|null,
 *         name?: scalar|Param|null,
 *         version?: scalar|Param|null,
 *         environment?: scalar|Param|null,
 *     },
 *     instrumentation?: array{
 *         cache?: array{
 *             tracing?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 tracer?: scalar|Param|null, // The tracer to use, defaults to `traces.default_tracer` or first tracer in `traces.tracers`
 *             },
 *             metering?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 meter?: scalar|Param|null, // The meter to use, defaults to `metrics.default_meter` or first meter in `metrics.meters`
 *             },
 *         },
 *         console?: array{
 *             type?: "auto"|"attribute"|Param, // Default: "auto"
 *             tracing?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 tracer?: scalar|Param|null, // The tracer to use, defaults to `traces.default_tracer` or first tracer in `traces.tracers`
 *                 exclude_commands?: list<scalar|Param|null>,
 *             },
 *             metering?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 meter?: scalar|Param|null, // The meter to use, defaults to `metrics.default_meter` or first meter in `metrics.meters`
 ...
 *     },
 *     traces?: array{
 *         tracers?: array<string, array{ // Default: []
 *             name?: scalar|Param|null,
 *             version?: scalar|Param|null,
 *             provider?: scalar|Param|null,
 *         }>,
 *         providers?: array<string, array{ // Default: []
 *             type?: "default"|"noop"|Param, // Default: "default"
 *             sampler?: string|array{
 *                 type?: "always_off"|"always_on"|"parent_based_always_off"|"parent_based_always_on"|"parent_based_trace_id_ratio"|"trace_id_ratio"|"attribute_based"|"service"|Param, // Default: "always_on"
 *                 service_id?: scalar|Param|null, // Required if sampler type is service
 *                 options?: list<scalar|Param|null>,
 *             },
 *             processors?: list<scalar|Param|null>,
 *         }>,
 *         processors?: array<string, array{ // Default: []
 *             type?: "multi"|"simple"|"noop"|Param, // Default: "simple"
 *             processors?: list<scalar|Param|null>,
 *             exporter?: scalar|Param|null, // Required if processor type is simple or batch
 *         }>,
 *         exporters?: array<string, array{ // Default: []
 *             dsn?: scalar|Param|null,
 *             options?: array{
 *                 format?: "json"|"ndjson"|"gprc"|"protobuf"|Param, // Default: "json"
 *                 compression?: "gzip"|"none"|Param, // Default: "none"
 *                 headers?: array<string, mixed>,
 *                 timeout?: float|Param, // Default: 0.1
 *                 retry?: int|Param, // Default: 100
 *                 max?: int|Param, // Default: 3
 *                 ca?: scalar|Param|null,
 *                 cert?: scalar|Param|null,
 *                 key?: scalar|Param|null,
 *             },
 *         }>,
 *     },
 *     metrics?: array{
 *         meters?: array<string, array{ // Default: []
 *             name?: scalar|Param|null,
 *             provider?: scalar|Param|null,
 *         }>,
 *         providers?: array<string, array{ // Default: []
 *             type?: "noop"|"default"|Param, // Default: "default"
 *             exporter?: scalar|Param|null,
 *             filter?: string|array{
 *                 type?: "all"|"none"|"with_sampled_trace"|"service"|Param, // Default: "none"
 *                 service_id?: scalar|Param|null, // Required if exemplar filter type is service
 *             },
 *         }>,
 *         exporters?: array<string, array{ // Default: []
 *             dsn?: scalar|Param|null,
 *             temporality?: "delta"|"cumulative"|"low_memory"|Param, // Default: "delta"
 *             options?: array{
 *                 format?: "json"|"ndjson"|"gprc"|"protobuf"|Param, // Default: "json"
 *                 compression?: "gzip"|"none"|Param, // Default: "none"
 *                 headers?: array<string, mixed>,
 ...
 *         providers?: array<string, array{ // Default: []
 *             type?: "default"|"noop"|Param, // Default: "default"
 *             processor?: scalar|Param|null,
 *         }>,
 *         processors?: array<string, array{ // Default: []
 *             type?: "batch"|"multi"|"noop"|"simple"|Param, // Default: "simple"
 *             processors?: list<scalar|Param|null>,
 *             batch?: array{ // Required if processor type is batch
 *                 clock?: scalar|Param|null, // Default: "open_telemetry.clock"
 *                 max_queue_size?: int|Param, // Default: 2048
 *                 schedule_delay?: int|Param, // Default: 1000
 *                 export_timeout?: int|Param, // Default: 30000
 *                 max_export_batch_size?: int|Param, // Default: 512
 *                 auto_flush?: bool|Param, // Default: true
 *                 meter_provider?: scalar|Param|null,
 *             },
 *             exporter?: scalar|Param|null, // Required if processor type is simple or batch
 *         }>,
 *         exporters?: array<string, array{ // Default: []
